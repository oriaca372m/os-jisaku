...
namespace graphics {
	...
	struct RGBResv8BitPerColorPixelWriterTraits final
		: public DevicePixelWriterTraitsBase<RGBResv8BitPerColorPixelWriter> {
	...
	struct BGRResv8BitPerColorPixelWriterTraits final
		: public DevicePixelWriterTraitsBase<BGRResv8BitPerColorPixelWriter> {
